...
class ControllerCheckoutOctFastorder extends Controller {
    public function index() {
        ...
        $data['refresh_after_citychange'] = isset($oct_fastorder_data['refresh_after_citychange']) ? $oct_fastorder_data['refresh_after_citychange'] : '';

        $data['show_payment_adres'] = isset($oct_fastorder_data['show_payment_adres']) ? $oct_fastorder_data['show_payment_adres'] : '';
