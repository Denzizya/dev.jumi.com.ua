...
class ModelCatalogProduct extends Model {
	...
	public function getProductSpecialsDataById($product_id) {
		$special_data = [];

		$sql = "SELECT ps.customer_group_id, ps.price FROM " . DB_PREFIX . "product_special ps WHERE product_id = '" . (int)$product_id . "'";
