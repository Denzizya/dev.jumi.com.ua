			...
			if (isset($result['oct_stickers']) && !empty($result['oct_stickers'])) {
				foreach ($result['oct_stickers'] as $oct_sticker) {
					...
					if ((isset($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['status']) && $oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['status'])) {
						if (isset($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['title'][(int)$this->config->get('config_language_id')]) && !empty($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['title'][(int)$this->config->get('config_language_id')]) && isset($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['image']) && $oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['image']) {
							
							$oct_stickers_data['stickers']['stickers_'.$oct_t_sticker[1]] = [];
							array_push($oct_stickers_data['stickers']['stickers_'.$oct_t_sticker[1]],$oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['title'][(int)$this->config->get('config_language_id')],$oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['image'],nl2br($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['description'][(int)$this->config->get('config_language_id')]));
							
						} elseif (isset($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['title'][(int)$this->config->get('config_language_id')]) && !empty($oct_stickers[$oct_t_sticker[0]][$oct_t_sticker[1]]['title'][(int)$this->config->get('config_language_id')])) {
